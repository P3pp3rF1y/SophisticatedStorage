...
public class StorageReiClientPlugin implements REIClientPlugin {
	...
	private static Identifier getCollapseId(StorageBlockItem storageItem) {
		return Identifier.fromNamespaceAndPath(SophisticatedStorage.MOD_ID, "rei_group/" + BuiltInRegistries.ITEM.getKey(storageItem).getPath());
	}

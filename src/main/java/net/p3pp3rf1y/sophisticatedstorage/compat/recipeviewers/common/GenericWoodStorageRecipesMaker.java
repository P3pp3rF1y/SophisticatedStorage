...
public class GenericWoodStorageRecipesMaker {
	...
	private static void addRecipes(List<CraftingRecipe> recipes, WoodType woodType, GenericWoodStorageHelper.GenericWoodInfo info) {
	...
	private static CraftingRecipe createRecipe(String storageName, WoodType woodType, Item item, Block planks, Block slab, String... pattern) {
		...
		return new ShapedRecipe(getRecipeId(storageName, woodType), "", CraftingBookCategory.MISC, 3, 3, ingredients, result);
	}

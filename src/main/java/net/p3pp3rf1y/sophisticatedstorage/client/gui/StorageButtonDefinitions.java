...
public class StorageButtonDefinitions {
	public static final ButtonDefinition.Toggle<ContentsFilterType> STORAGE_CONTENTS_FILTER_TYPE = createToggleButtonDefinition(Map.of(ContentsFilterType.ALLOW,
			...
			ContentsFilterType.STORAGE, getButtonStateData(new UV(64, 16), StorageTranslationHelper.INSTANCE.translUpgradeButton("match_storage_contents"),
	...
	public static final ButtonDefinition.Toggle<IOMode> IO_MODE = createToggleButtonDefinition(Map.of(IOMode.PUSH,

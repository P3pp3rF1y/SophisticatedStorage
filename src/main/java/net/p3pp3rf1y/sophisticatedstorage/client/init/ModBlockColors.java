...
public class ModBlockColors {
	...
	public static void registerBlockColorHandlers(RegisterColorHandlersEvent.BlockTintSources event) {
		event.register(List.of(new MainColorTintSource(), new AccentColorTintSource()),
		...
		event.register(List.of(new MainColorTintSource()), ModBlocks.CHEST.get(), ModBlocks.COPPER_CHEST.get(), ModBlocks.IRON_CHEST.get(), ModBlocks.GOLD_CHEST.get(), ModBlocks.DIAMOND_CHEST.get(), ModBlocks.NETHERITE_CHEST.get(),

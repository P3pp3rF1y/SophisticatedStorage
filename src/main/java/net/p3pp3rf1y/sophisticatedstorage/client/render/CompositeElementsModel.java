...
//
// @Override
// public BakedModel bake(TextureSlots textures, ModelBaker baker, ModelState modelState, boolean hasAmbientOcclusion, boolean usesBlockLight, ItemTransforms
// itemTransforms, ContextMap additionalProperties) {
...
// SophisticatedStorage.LOGGER.warn("Unable to resolve texture due to reference chain {}->{} in {}", () -> Joiner.on("->").join(visitedTextureReferences), () ->

...
public class BarrelUnbakedModel extends BarrelUnbakedModelBase {
	...
	public BarrelUnbakedModel(@Nullable ResourceLocation parentLocation, Map<String, Map<BarrelModelPart, BarrelModelPartDefinition>> woodOverrides,
	...
	private static class BarrelBlockStateModel extends BarrelBlockStateModelBase {
		public BarrelBlockStateModel(ModelBaker baker, Map<String, Map<BarrelModelPart, QuadCollection>> woodModelParts,
				Map<String, Map<BarrelModelPart, TextureAtlasSprite>> particleIcons,
				Map<String, Map<DynamicBarrelBakingData.DynamicPart, DynamicBarrelBakingData>> woodDynamicBakingData,
				Map<String, Map<BarrelModelPart, QuadCollection>> woodPartitionedModelParts) {
	...
	public static final class Loader extends BarrelUnbakedModelBase.Loader<BarrelUnbakedModel> {
		...
		@Override
		protected BarrelUnbakedModel instantiateModel(@Nullable ResourceLocation parentLocation,

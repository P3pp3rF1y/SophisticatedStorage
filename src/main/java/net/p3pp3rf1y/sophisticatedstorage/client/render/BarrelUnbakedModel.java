...
public class BarrelUnbakedModel extends BarrelUnbakedModelBase {
	...
	public BarrelUnbakedModel(@Nullable Identifier parentLocation, Map<String, Map<BarrelModelPart, BarrelModelPartDefinition>> woodOverrides,
	...
	public static final class Loader extends BarrelUnbakedModelBase.Loader<BarrelUnbakedModel> {
		...
		@Override
		protected BarrelUnbakedModel instantiateModel(@Nullable Identifier parentLocation,

...
public class ShulkerBoxRenderer extends StorageRenderer<ShulkerBoxBlockEntity> {
	...
	public void render(ShulkerBoxBlockEntity shulkerBoxEntity, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight,
		...
		render(shulkerBoxEntity, partialTick, poseStack, bufferSource, packedLight, packedOverlay, cameraPos, false);
	}

	public void render(ShulkerBoxBlockEntity shulkerBoxEntity, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight,
			int packedOverlay, Vec3 cameraPos, boolean forceClosedPreview) {

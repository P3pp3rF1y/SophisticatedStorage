...
public class ShulkerBoxRenderer extends StorageRenderer<ShulkerBoxBlockEntity, ShulkerBoxRenderer.ShulkerBoxRenderState> {
	...
	private static final SpriteId BASE_TIER_MATERIAL = new SpriteId(net.minecraft.client.renderer.Sheets.SHULKER_SHEET,
			SophisticatedStorage.getIdentifier(ENTITY_SHULKER_BOX_FOLDER + "base_tier"));
	private static final SpriteId COPPER_TIER_MATERIAL = new SpriteId(net.minecraft.client.renderer.Sheets.SHULKER_SHEET,
			SophisticatedStorage.getIdentifier(ENTITY_SHULKER_BOX_FOLDER + "copper_tier"));
	private static final SpriteId IRON_TIER_MATERIAL = new SpriteId(net.minecraft.client.renderer.Sheets.SHULKER_SHEET,
			SophisticatedStorage.getIdentifier(ENTITY_SHULKER_BOX_FOLDER + "iron_tier"));
	private static final SpriteId GOLD_TIER_MATERIAL = new SpriteId(net.minecraft.client.renderer.Sheets.SHULKER_SHEET,
			SophisticatedStorage.getIdentifier(ENTITY_SHULKER_BOX_FOLDER + "gold_tier"));
	private static final SpriteId DIAMOND_TIER_MATERIAL = new SpriteId(net.minecraft.client.renderer.Sheets.SHULKER_SHEET,
			SophisticatedStorage.getIdentifier(ENTITY_SHULKER_BOX_FOLDER + "diamond_tier"));
	private static final SpriteId NETHERITE_TIER_MATERIAL = new SpriteId(net.minecraft.client.renderer.Sheets.SHULKER_SHEET,
			SophisticatedStorage.getIdentifier(ENTITY_SHULKER_BOX_FOLDER + "netherite_tier"));
	private static final SpriteId TINTABLE_MAIN_MATERIAL = new SpriteId(net.minecraft.client.renderer.Sheets.SHULKER_SHEET,
			SophisticatedStorage.getIdentifier(ENTITY_SHULKER_BOX_FOLDER + "tintable_main"));
	private static final SpriteId TINTABLE_ACCENT_MATERIAL = new SpriteId(net.minecraft.client.renderer.Sheets.SHULKER_SHEET,
			SophisticatedStorage.getIdentifier(ENTITY_SHULKER_BOX_FOLDER + "tintable_accent"));
	private static final SpriteId NO_TINT_MATERIAL = new SpriteId(net.minecraft.client.renderer.Sheets.SHULKER_SHEET,

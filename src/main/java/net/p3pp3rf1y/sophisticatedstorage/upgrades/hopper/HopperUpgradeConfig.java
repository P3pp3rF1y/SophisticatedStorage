...
public class HopperUpgradeConfig {
	...
	public HopperUpgradeConfig(ForgeConfigSpec.Builder builder, String upgradeName, String path, int defaultInputFilterSlots, int defaultInputFilterSlotsInRow,
			int defaultOutputFilterSlots, int defaultOutputFilterSlotsInRow, int defaultTransferSpeedTicks, int defaultMaxTransferStackSize) {
		...
		inputFilterSlotsInRow = builder.comment("Number of input filter slots displayed in a row").defineInRange("inputFilterSlotsInRow",
				defaultInputFilterSlotsInRow, 1, 4);
		...
		outputFilterSlotsInRow = builder.comment("Number of fuel filter slots displayed in a row").defineInRange("outputFilterSlotsInRow",
				defaultOutputFilterSlotsInRow, 1, 4);
		...
		maxTransferStackSize = builder.comment("Maximum stack size that can be transferred in one transfer").defineInRange("maxTransferStackSize",
				defaultMaxTransferStackSize, 1, 64);
		builder.pop();

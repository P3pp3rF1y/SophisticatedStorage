...
public class StorageHolderTierUpgradeHandler {
	...
	public static InteractionResult upgrade(Player player, StorageHolderBase storageHolder, ItemStack itemInHand, StorageTierUpgradeItem tierUpgradeItem) {
		...
		if (!storageHolder.isOpen() && !storageHolder.isPacked()) {
			...
			if (countRequired > itemInHand.getCount()) {
				player.sendOverlayMessage(Component.translatable(StorageTranslationHelper.INSTANCE.translGui("status.too_low_tier_upgrade_count"),
						countRequired, itemInHand.getHoverName()));
	...
	static {
		STORAGE_HOLDER_TIER_UPGRADE_DEFINITIONS.put(StorageTierUpgradeItem.TierUpgrade.BASIC_TO_COPPER,
		...
		STORAGE_HOLDER_TIER_UPGRADE_DEFINITIONS.put(StorageTierUpgradeItem.TierUpgrade.BASIC_TO_IRON,
		...
		STORAGE_HOLDER_TIER_UPGRADE_DEFINITIONS.put(StorageTierUpgradeItem.TierUpgrade.BASIC_TO_GOLD,
		...
		STORAGE_HOLDER_TIER_UPGRADE_DEFINITIONS.put(StorageTierUpgradeItem.TierUpgrade.BASIC_TO_DIAMOND,
		...
		STORAGE_HOLDER_TIER_UPGRADE_DEFINITIONS.put(StorageTierUpgradeItem.TierUpgrade.BASIC_TO_NETHERITE,
		...
		STORAGE_HOLDER_TIER_UPGRADE_DEFINITIONS.put(StorageTierUpgradeItem.TierUpgrade.COPPER_TO_IRON,
				Map.of(ModBlocks.COPPER_BARREL_ITEM.get(), new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.IRON_BARREL_ITEM.get()),
						...
						new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.LIMITED_IRON_BARREL_4_ITEM.get())));
		STORAGE_HOLDER_TIER_UPGRADE_DEFINITIONS.put(StorageTierUpgradeItem.TierUpgrade.COPPER_TO_GOLD,
				Map.of(ModBlocks.COPPER_BARREL_ITEM.get(), new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.GOLD_BARREL_ITEM.get()),
						...
						ModBlocks.LIMITED_COPPER_BARREL_4_ITEM.get(),
						new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.LIMITED_GOLD_BARREL_4_ITEM.get())));
		STORAGE_HOLDER_TIER_UPGRADE_DEFINITIONS.put(StorageTierUpgradeItem.TierUpgrade.COPPER_TO_DIAMOND, Map.of(ModBlocks.COPPER_BARREL_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.DIAMOND_BARREL_ITEM.get()), ModBlocks.COPPER_CHEST_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.DIAMOND_CHEST_ITEM.get()), ModBlocks.COPPER_SHULKER_BOX_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.DIAMOND_SHULKER_BOX_ITEM.get()),
				ModBlocks.LIMITED_COPPER_BARREL_1_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.LIMITED_DIAMOND_BARREL_1_ITEM.get()),
				ModBlocks.LIMITED_COPPER_BARREL_2_ITEM.get(),
				...
				ModBlocks.LIMITED_COPPER_BARREL_4_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.LIMITED_DIAMOND_BARREL_4_ITEM.get())));
		STORAGE_HOLDER_TIER_UPGRADE_DEFINITIONS.put(StorageTierUpgradeItem.TierUpgrade.COPPER_TO_NETHERITE, Map.of(ModBlocks.COPPER_BARREL_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.NETHERITE_BARREL_ITEM.get()), ModBlocks.COPPER_CHEST_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.NETHERITE_CHEST_ITEM.get()),
				ModBlocks.COPPER_SHULKER_BOX_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.NETHERITE_SHULKER_BOX_ITEM.get()),
				ModBlocks.LIMITED_COPPER_BARREL_1_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.LIMITED_NETHERITE_BARREL_1_ITEM.get()),
		...
		STORAGE_HOLDER_TIER_UPGRADE_DEFINITIONS.put(StorageTierUpgradeItem.TierUpgrade.IRON_TO_GOLD,
				Map.of(ModBlocks.IRON_BARREL_ITEM.get(), new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.GOLD_BARREL_ITEM.get()),
						...
						new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.LIMITED_GOLD_BARREL_4_ITEM.get())));
		STORAGE_HOLDER_TIER_UPGRADE_DEFINITIONS.put(StorageTierUpgradeItem.TierUpgrade.IRON_TO_DIAMOND, Map.of(ModBlocks.IRON_BARREL_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.DIAMOND_BARREL_ITEM.get()), ModBlocks.IRON_CHEST_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.DIAMOND_CHEST_ITEM.get()), ModBlocks.IRON_SHULKER_BOX_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.DIAMOND_SHULKER_BOX_ITEM.get()),
				ModBlocks.LIMITED_IRON_BARREL_1_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.LIMITED_DIAMOND_BARREL_1_ITEM.get()),
				ModBlocks.LIMITED_IRON_BARREL_2_ITEM.get(),
				...
				ModBlocks.LIMITED_IRON_BARREL_4_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.LIMITED_DIAMOND_BARREL_4_ITEM.get())));
		STORAGE_HOLDER_TIER_UPGRADE_DEFINITIONS.put(StorageTierUpgradeItem.TierUpgrade.IRON_TO_NETHERITE, Map.of(ModBlocks.IRON_BARREL_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.NETHERITE_BARREL_ITEM.get()), ModBlocks.IRON_CHEST_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.NETHERITE_CHEST_ITEM.get()), ModBlocks.IRON_SHULKER_BOX_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.NETHERITE_SHULKER_BOX_ITEM.get()),
				ModBlocks.LIMITED_IRON_BARREL_1_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.LIMITED_NETHERITE_BARREL_1_ITEM.get()),
				ModBlocks.LIMITED_IRON_BARREL_2_ITEM.get(),
		...
		STORAGE_HOLDER_TIER_UPGRADE_DEFINITIONS.put(StorageTierUpgradeItem.TierUpgrade.GOLD_TO_DIAMOND, Map.of(ModBlocks.GOLD_BARREL_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.DIAMOND_BARREL_ITEM.get()), ModBlocks.GOLD_CHEST_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.DIAMOND_CHEST_ITEM.get()), ModBlocks.GOLD_SHULKER_BOX_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.DIAMOND_SHULKER_BOX_ITEM.get()),
				...
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.LIMITED_DIAMOND_BARREL_4_ITEM.get())));
		STORAGE_HOLDER_TIER_UPGRADE_DEFINITIONS.put(StorageTierUpgradeItem.TierUpgrade.GOLD_TO_NETHERITE, Map.of(ModBlocks.GOLD_BARREL_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.NETHERITE_BARREL_ITEM.get()), ModBlocks.GOLD_CHEST_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.NETHERITE_CHEST_ITEM.get()), ModBlocks.GOLD_SHULKER_BOX_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.NETHERITE_SHULKER_BOX_ITEM.get()),
				ModBlocks.LIMITED_GOLD_BARREL_1_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.LIMITED_NETHERITE_BARREL_1_ITEM.get()),
				ModBlocks.LIMITED_GOLD_BARREL_2_ITEM.get(),
		...
		STORAGE_HOLDER_TIER_UPGRADE_DEFINITIONS.put(StorageTierUpgradeItem.TierUpgrade.DIAMOND_TO_NETHERITE, Map.of(ModBlocks.DIAMOND_BARREL_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.NETHERITE_BARREL_ITEM.get()), ModBlocks.DIAMOND_CHEST_ITEM.get(),
				new StorageHolderTierUpgradeHandler.StorageHolderUpgradeDefinition(ModBlocks.NETHERITE_CHEST_ITEM.get()),

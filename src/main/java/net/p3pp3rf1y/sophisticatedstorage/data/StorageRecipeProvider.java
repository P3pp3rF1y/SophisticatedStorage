...
public class StorageRecipeProvider extends RecipeProvider {
	...
	protected void buildRecipes(RecipeOutput recipeOutput) {
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.PACKING_TAPE.get()).requires(Tags.Items.SLIME_BALLS).requires(Items.PAPER)
				.unlockedBy("has_slime", has(Tags.Items.SLIME_BALLS)).save(recipeOutput.withConditions(new DropPackedDisabledCondition()));

		ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.SUPER_PACKING_TAPE.get()).requires(ModItems.PACKING_TAPE.get())
				.requires(ModItems.PACKING_TAPE.get()).requires(ModItems.PACKING_TAPE.get()).requires(ModItems.PACKING_TAPE.get())
				.unlockedBy("has_packing_tape", has(ModItems.PACKING_TAPE.get())).save(recipeOutput.withConditions(new DropPackedDisabledCondition()));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.PAINTBRUSH.get()).pattern(" W ").pattern(" SW").pattern("S  ")
				...
				.unlockedBy("has_base_tier_wooden_storage", has(ModBlocks.BASE_TIER_WOODEN_STORAGE_TAG)).save(recipeOutput);
	}
	...
	private void addBackpackStackUpgradeFromStorageStackUpgradeRecipe(RecipeOutput recipeOutput, StackUpgradeItem backpackStackUpgrade,
		...
		ShapeBasedRecipeBuilder.shaped(backpackStackUpgrade).pattern("TST").pattern("SLS").pattern("T T").define('T', Tags.Items.STRINGS)
				.define('L', Tags.Items.LEATHERS).define('S', storageStackUpgrade).unlockedBy("has_storage_stack_upgrade", has(storageStackUpgrade))
				.save(recipeOutput, SophisticatedStorage.getRL("backpack_" + RegistryHelper.getItemKey(backpackStackUpgrade).getPath() + "_from_storage_"
	...
	private void addBackpackUpgradeFromStorageUpgradeRecipe(RecipeOutput recipeOutput, UpgradeItemBase<?> backpackUpgrade, UpgradeItemBase<?> storageUpgrade) {
		ShapeBasedRecipeBuilder.shaped(backpackUpgrade).pattern("TUT").pattern(" L ").pattern("T T").define('T', Tags.Items.STRINGS)
				.define('L', Tags.Items.LEATHERS).define('U', storageUpgrade).unlockedBy("has_storage_upgrade", has(storageUpgrade))
				.save(recipeOutput, SophisticatedStorage.getRL("backpack_" + RegistryHelper.getItemKey(backpackUpgrade).getPath() + "_from_storage_"
						+ RegistryHelper.getItemKey(storageUpgrade).getPath()));
	}
	...
	private void addStorageUpgradeFromBackpackUpgradeRecipe(RecipeOutput recipeOutput, UpgradeItemBase<?> storageUpgrade, UpgradeItemBase<?> backpackUpgrade) {
		ShapeBasedRecipeBuilder.shaped(storageUpgrade).pattern("PUP").pattern(" P ").pattern("P P").define('P', ItemTags.PLANKS).define('U', backpackUpgrade)
				.unlockedBy("has_backpack_upgrade", has(backpackUpgrade)).save(recipeOutput, SophisticatedStorage.getRL("storage_"
						+ RegistryHelper.getItemKey(storageUpgrade).getPath() + "_from_backpack_" + RegistryHelper.getItemKey(backpackUpgrade).getPath()));
	}

	private static void addStorageStackUpgradeFromBackpackStackUpgradeRecipe(RecipeOutput recipeOutput, StackUpgradeItem storageStackUpgrade,
			StackUpgradeItem backpackStackUpgrade) {
		ShapeBasedRecipeBuilder.shaped(new ItemStack(storageStackUpgrade, 3)).pattern("PSP").pattern(" P ").pattern("P P").define('P', ItemTags.PLANKS)
				.define('S', backpackStackUpgrade).unlockedBy("has_backpack_stack_upgrade", has(backpackStackUpgrade))
				.save(recipeOutput, SophisticatedStorage.getRL("storage_" + RegistryHelper.getItemKey(storageStackUpgrade).getPath() + "_from_backpack_"
	...
	private void addLimitedBarrelRecipes(RecipeOutput recipeOutput) {
		...
		ShapeBasedRecipeBuilder
				.shaped(WoodStorageBlockItem.setWoodType(new ItemStack(ModBlocks.LIMITED_BARREL_1_ITEM.get()), WoodType.SPRUCE), GenericWoodStorageRecipe::new)
				.pattern("PSP").pattern("PLP").pattern("PPP").define('P', ItemTags.PLANKS).define('S', ItemTags.WOODEN_SLABS).define('L', Blocks.LEVER)
				.unlockedBy("has " + PLANK_SUFFIX, has(ItemTags.PLANKS)).save(recipeOutput, SophisticatedStorage.getRL("generic_limited_barrel_1"));

		ShapeBasedRecipeBuilder
				.shaped(WoodStorageBlockItem.setWoodType(new ItemStack(ModBlocks.LIMITED_BARREL_2_ITEM.get()), WoodType.SPRUCE), GenericWoodStorageRecipe::new)
				.pattern("PPP").pattern("SLS").pattern("PPP").define('P', ItemTags.PLANKS).define('S', ItemTags.WOODEN_SLABS).define('L', Blocks.LEVER)
				.unlockedBy("has " + PLANK_SUFFIX, has(ItemTags.PLANKS)).save(recipeOutput, SophisticatedStorage.getRL("generic_limited_barrel_2"));

		ShapeBasedRecipeBuilder
				.shaped(WoodStorageBlockItem.setWoodType(new ItemStack(ModBlocks.LIMITED_BARREL_3_ITEM.get()), WoodType.SPRUCE), GenericWoodStorageRecipe::new)
				.pattern("PSP").pattern("PLP").pattern("SPS").define('P', ItemTags.PLANKS).define('S', ItemTags.WOODEN_SLABS).define('L', Blocks.LEVER)
				.unlockedBy("has " + PLANK_SUFFIX, has(ItemTags.PLANKS)).save(recipeOutput, SophisticatedStorage.getRL("generic_limited_barrel_3"));

		ShapeBasedRecipeBuilder
				.shaped(WoodStorageBlockItem.setWoodType(new ItemStack(ModBlocks.LIMITED_BARREL_4_ITEM.get()), WoodType.SPRUCE), GenericWoodStorageRecipe::new)
				.pattern("SPS").pattern("PLP").pattern("SPS").define('P', ItemTags.PLANKS).define('S', ItemTags.WOODEN_SLABS).define('L', Blocks.LEVER)
				.unlockedBy("has " + PLANK_SUFFIX, has(ItemTags.PLANKS)).save(recipeOutput, SophisticatedStorage.getRL("generic_limited_barrel_4"));
	...
	private void addStorageTierUpgradeRecipes(RecipeOutput recipeOutput, BlockItem baseTierItem, BlockItem copperTierItem, BlockItem ironTierItem,
		...
		ShapeBasedRecipeBuilder.shaped(copperTierItem, StorageTierUpgradeRecipe::new).pattern("CCC").pattern("CSC").pattern("CCC")
		...
		ShapeBasedRecipeBuilder.shaped(ironTierItem, StorageTierUpgradeRecipe::new).pattern(" I ").pattern("ISI").pattern(" I ")
				.define('I', Tags.Items.INGOTS_IRON).define('S', copperTierItem)
				.unlockedBy("has_" + RegistryHelper.getItemKey(copperTierItem).getPath(), has(copperTierItem)).save(recipeOutput, SophisticatedStorage
						.getRL(RegistryHelper.getItemKey(ironTierItem).getPath() + "_from_" + RegistryHelper.getItemKey(copperTierItem).getPath()));

		ShapeBasedRecipeBuilder.shaped(ironTierItem, StorageTierUpgradeRecipe::new).pattern("III").pattern("ISI").pattern("III")
				.define('I', Tags.Items.INGOTS_IRON).define('S', baseTierItem)
				.unlockedBy("has_" + RegistryHelper.getItemKey(baseTierItem).getPath(), has(baseTierItem)).save(recipeOutput);

		ShapeBasedRecipeBuilder.shaped(goldTierItem, StorageTierUpgradeRecipe::new).pattern("GGG").pattern("GSG").pattern("GGG")
		...
		ShapeBasedRecipeBuilder.shaped(diamondTierItem, StorageTierUpgradeRecipe::new).pattern("DDD").pattern("DSD").pattern("DDD")
		...
		ShapelessBasedRecipeBuilder.shapeless(netheriteTierItem, StorageTierUpgradeShapelessRecipe::new).requires(Ingredient.of(diamondTierItem))
	...
	private void addDoubleChestTierUpgradeRecipes(RecipeOutput recipeOutput, BlockItem baseTierItem, BlockItem copperTierItem, BlockItem ironTierItem,
			BlockItem goldTierItem, BlockItem diamondTierItem, BlockItem netheriteTierItem) {
		ShapeBasedRecipeBuilder.shaped(copperTierItem, DoubleChestTierUpgradeRecipe::new).pattern("CCC").pattern("CSC").pattern("CBC")
		...
		ShapeBasedRecipeBuilder.shaped(ironTierItem, DoubleChestTierUpgradeRecipe::new).pattern("III").pattern("ISI").pattern("III")
				.define('I', Tags.Items.INGOTS_IRON).define('S', copperTierItem)
				.unlockedBy("has_" + RegistryHelper.getItemKey(copperTierItem).getPath(), has(copperTierItem)).save(recipeOutput, SophisticatedStorage
						.getRL("double_" + RegistryHelper.getItemKey(ironTierItem).getPath() + "_from_" + RegistryHelper.getItemKey(copperTierItem).getPath()));

		ShapeBasedRecipeBuilder.shaped(ironTierItem, DoubleChestTierUpgradeRecipe::new).pattern("III").pattern("ISI").pattern("IBI")
		...
		ShapeBasedRecipeBuilder.shaped(goldTierItem, DoubleChestTierUpgradeRecipe::new).pattern("GGG").pattern("GSG").pattern("GBG")
		...
		ShapeBasedRecipeBuilder.shaped(diamondTierItem, DoubleChestTierUpgradeRecipe::new).pattern("DDD").pattern("DSD").pattern("DBD")
		...
		ShapelessBasedRecipeBuilder.shapeless(netheriteTierItem, DoubleChestTierUpgradeShapelessRecipe::new).requires(Ingredient.of(diamondTierItem))
	...
	private void addControllerRelatedRecipes(RecipeOutput recipeOutput) {
		ShapeBasedRecipeBuilder.shaped(ModBlocks.CONTROLLER_ITEM.get()).pattern("SCS").pattern("PBP").pattern("SCS").define('S', Tags.Items.STONES)
		...
		ShapeBasedRecipeBuilder.shaped(ModBlocks.STORAGE_IO_ITEM.get()).pattern("SPS").pattern("RBG").pattern("SPS").define('S', Tags.Items.STONES)
		...
		ShapeBasedRecipeBuilder.shaped(ModBlocks.STORAGE_OUTPUT_ITEM.get()).pattern("SGS").pattern("PBP").pattern("SRS").define('S', Tags.Items.STONES)
				.define('P', ItemTags.PLANKS).define('R', Items.REPEATER).define('G', Tags.Items.INGOTS_GOLD)
				.define('B', new BaseTierWoodenStorageIngredient().toVanilla())
				.unlockedBy(HAS_BASE_TIER_WOODEN_STORAGE_CRITERION_NAME, has(ModBlocks.BASE_TIER_WOODEN_STORAGE_TAG)).save(recipeOutput);

		ShapeBasedRecipeBuilder.shaped(ModBlocks.STORAGE_INPUT_ITEM.get()).pattern("SRS").pattern("PBP").pattern("SGS").define('S', Tags.Items.STONES)
				.define('P', ItemTags.PLANKS).define('R', Items.REPEATER).define('G', Tags.Items.INGOTS_GOLD)
				.define('B', new BaseTierWoodenStorageIngredient().toVanilla())
				.unlockedBy(HAS_BASE_TIER_WOODEN_STORAGE_CRITERION_NAME, has(ModBlocks.BASE_TIER_WOODEN_STORAGE_TAG)).save(recipeOutput);
		...
		WoodStorageBlockBase.CUSTOM_TEXTURE_WOOD_TYPES.entrySet().forEach(entry -> {
			...
			ShapeBasedRecipeBuilder.shaped(new ItemStack(ModBlocks.STORAGE_CONNECTOR_BLOCKS.get(woodType).get(), 4)).pattern("SPS").pattern("PSP")
					.pattern("SPS").define('S', Items.STICK).define('P', plankBlock)
					.unlockedBy("has_" + RegistryHelper.getBlockKey(plankBlock).getPath(), has(plankBlock)).save(recipeOutput);
		});
	}
	...
	private void addShulkerBoxRecipes(RecipeOutput recipeOutput) {
		...
		ShapelessBasedRecipeBuilder.shapeless(ModBlocks.SHULKER_BOX_ITEM.get(), ShulkerBoxFromVanillaShapelessRecipe::new).requires(Items.SHULKER_BOX)
		...
		ShapeBasedRecipeBuilder.shaped(ModBlocks.SHULKER_BOX_ITEM.get(), ShulkerBoxFromChestRecipe::new).pattern("S").pattern("C").pattern("S")
		...
		ShapeBasedRecipeBuilder.shaped(ModBlocks.COPPER_SHULKER_BOX_ITEM.get(), ShulkerBoxFromChestRecipe::new).pattern("S").pattern("C").pattern("S")
		...
		ShapeBasedRecipeBuilder.shaped(ModBlocks.IRON_SHULKER_BOX_ITEM.get(), ShulkerBoxFromChestRecipe::new).pattern("S").pattern("C").pattern("S")
		...
		ShapeBasedRecipeBuilder.shaped(ModBlocks.GOLD_SHULKER_BOX_ITEM.get(), ShulkerBoxFromChestRecipe::new).pattern("S").pattern("C").pattern("S")
		...
		ShapeBasedRecipeBuilder.shaped(ModBlocks.DIAMOND_SHULKER_BOX_ITEM.get(), ShulkerBoxFromChestRecipe::new).pattern("S").pattern("C").pattern("S")
		...
		ShapeBasedRecipeBuilder.shaped(ModBlocks.NETHERITE_SHULKER_BOX_ITEM.get(), ShulkerBoxFromChestRecipe::new).pattern("S").pattern("C").pattern("S")
	...
	private void addTierUpgradeItemRecipes(RecipeOutput recipeOutput) {
		...
		ShapelessBasedRecipeBuilder.shapeless(ModItems.DIAMOND_TO_NETHERITE_TIER_UPGRADE.get()).requires(Items.LEVER).requires(Tags.Items.INGOTS_NETHERITE)
				.unlockedBy(HAS_LEVER_CRITERION_NAME, has(Items.LEVER)).save(recipeOutput);
	}
	...
	private void addUpgradeRecipes(RecipeOutput recipeOutput) {
		...
		ShapeBasedRecipeBuilder.shaped(ModItems.FILTER_UPGRADE.get()).pattern("RSR").pattern("SBS").pattern("RSR").define('B', ModItems.UPGRADE_BASE.get())
				.define('R', Tags.Items.DUSTS_REDSTONE).define('S', Tags.Items.STRINGS)
				.unlockedBy(HAS_UPGRADE_BASE_CRITERION_NAME, has(ModItems.UPGRADE_BASE.get())).save(recipeOutput);
		...
		ShapeBasedRecipeBuilder.shaped(ModItems.ADVANCED_HOPPER_UPGRADE.get(), UpgradeNextTierRecipe::new).pattern(" D ").pattern("GHG").pattern("ROR")
	...
	private static void addCompatUpgradeRecipe(RecipeOutput recipeOutput, Item upgrade, Block workbench, Item backpackUpgrade, String modId) {
		...
		ShapeBasedRecipeBuilder.shaped(upgrade).pattern("PUP").pattern(" P ").pattern("P P").define('P', ItemTags.PLANKS).define('U', backpackUpgrade)
				.unlockedBy("has_backpack_upgrade", has(backpackUpgrade)).save(sbCompatRecipeWithoutAdvancements, ResourceLocation.fromNamespaceAndPath(
						SophisticatedStorage.MOD_ID, "storage_" + getCompatItemPath(upgrade) + "_from_backpack_" + getCompatItemPath(backpackUpgrade)));

		// backpack from storage upgrade
		ShapeBasedRecipeBuilder.shaped(backpackUpgrade).pattern("TUT").pattern(" L ").pattern("T T").define('T', Tags.Items.STRINGS)
				.define('L', Tags.Items.LEATHERS).define('U', upgrade).unlockedBy("has_storage_upgrade", has(upgrade))
				.save(sbCompatRecipeWithoutAdvancements, ResourceLocation.fromNamespaceAndPath(SophisticatedStorage.MOD_ID,
	...
	private void addChestRecipes(RecipeOutput recipeOutput) {
		...
		ShapeBasedRecipeBuilder.shaped(WoodStorageBlockItem.setWoodType(new ItemStack(ModBlocks.CHEST_ITEM.get()), WoodType.OAK), GenericWoodStorageRecipe::new)
				...
				.unlockedBy("has " + PLANK_SUFFIX, has(ItemTags.PLANKS)).save(recipeOutput, SophisticatedStorage.getRL("generic_chest"));
	...
	private void addQuarkChestRecipe(RecipeOutput recipeOutput, String name, WoodType woodType) {
		...
		ShapelessBasedRecipeBuilder.shapeless(WoodStorageBlockItem.setWoodType(new ItemStack(ModBlocks.CHEST_ITEM.get()), woodType)).requires(chestBlock)
				.requires(Blocks.LEVER).unlockedBy("has_vanilla_chest", has(Blocks.CHEST))
				.save(recipeOutput.withConditions(new ItemExistsCondition(chestRegistryName)),
	...
	private void addBarrelRecipes(RecipeOutput recipeOutput) {
		...
		ShapeBasedRecipeBuilder
				.shaped(WoodStorageBlockItem.setWoodType(new ItemStack(ModBlocks.BARREL_ITEM.get()), WoodType.SPRUCE), GenericWoodStorageRecipe::new)
				.pattern("PSP").pattern("PLP").pattern("PSP").define('P', ItemTags.PLANKS).define('S', ItemTags.WOODEN_SLABS).define('L', Blocks.LEVER)
				.unlockedBy("has " + PLANK_SUFFIX, has(ItemTags.PLANKS)).save(recipeOutput, SophisticatedStorage.getRL("generic_barrel"));
	...
	private void limitedWoodBarrelRecipe(RecipeOutput recipeOutput, WoodType woodType, Block planks, Block slab, Consumer<ShapedRecipeBuilder> addPattern,
			BlockItem item) {
		ShapedRecipeBuilder builder = ShapeBasedRecipeBuilder.shaped(WoodStorageBlockItem.setWoodType(new ItemStack(item), woodType)).define('P', planks)
	...
	private void tintedShulkerBoxRecipe(RecipeOutput recipeOutput, Block vanillaShulkerBox, DyeColor dyeColor) {
		...
		ShapelessBasedRecipeBuilder.shapeless(ModBlocks.SHULKER_BOX.get().getTintedStack(dyeColor), ShulkerBoxFromVanillaShapelessRecipe::new)

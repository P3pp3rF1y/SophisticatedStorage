...
public class StorageRecipeProvider extends RecipeProvider {
	...
	private void addBackpackStackUpgradeFromStorageStackUpgradeRecipe(RecipeOutput recipeOutput, StackUpgradeItem backpackStackUpgrade,
		...
		ShapeBasedRecipeBuilder.shaped(items, backpackStackUpgrade).pattern("TST").pattern("SLS").pattern("T T").define('T', Tags.Items.STRINGS)
				...
				.save(recipeOutput,
						ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getRL("backpack_" + RegistryHelper.getItemKey(backpackStackUpgrade).getPath()
								+ "_from_storage_" + RegistryHelper.getItemKey(storageStackUpgrade).getPath())));
	}
	...
	private void addBackpackUpgradeFromStorageUpgradeRecipe(RecipeOutput recipeOutput, UpgradeItemBase<?> backpackUpgrade, UpgradeItemBase<?> storageUpgrade) {
		ShapeBasedRecipeBuilder.shaped(items, backpackUpgrade).pattern("TUT").pattern(" L ").pattern("T T").define('T', Tags.Items.STRINGS)
				...
				.save(recipeOutput, ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getRL("backpack_"
	...
	private void addStorageUpgradeFromBackpackUpgradeRecipe(RecipeOutput recipeOutput, UpgradeItemBase<?> storageUpgrade, UpgradeItemBase<?> backpackUpgrade) {
		ShapeBasedRecipeBuilder.shaped(items, storageUpgrade).pattern("PUP").pattern(" P ").pattern("P P").define('P', ItemTags.PLANKS)
				...
				.save(recipeOutput, ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getRL("storage_"
	...
	private void addStorageStackUpgradeFromBackpackStackUpgradeRecipe(RecipeOutput recipeOutput, StackUpgradeItem storageStackUpgrade,
		...
		ShapeBasedRecipeBuilder.shaped(items, new ItemStack(storageStackUpgrade, 3)).pattern("PSP").pattern(" P ").pattern("P P").define('P', ItemTags.PLANKS)
				.define('S', backpackStackUpgrade).unlockedBy("has_backpack_stack_upgrade", has(backpackStackUpgrade)).save(recipeOutput,
						ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getRL("storage_" + RegistryHelper.getItemKey(storageStackUpgrade).getPath()
								+ "_from_backpack_" + RegistryHelper.getItemKey(backpackStackUpgrade).getPath())));
	}
	...
	private void addLimitedBarrelRecipes(RecipeOutput recipeOutput) {
		...
		ShapeBasedRecipeBuilder
				.shaped(items, WoodStorageBlockItem.setWoodType(new ItemStack(ModBlocks.LIMITED_BARREL_1_ITEM.get()), WoodType.SPRUCE),
		...
		ShapeBasedRecipeBuilder
				.shaped(items, WoodStorageBlockItem.setWoodType(new ItemStack(ModBlocks.LIMITED_BARREL_2_ITEM.get()), WoodType.SPRUCE),
						GenericWoodStorageRecipe::new)
		...
		ShapeBasedRecipeBuilder
				.shaped(items, WoodStorageBlockItem.setWoodType(new ItemStack(ModBlocks.LIMITED_BARREL_3_ITEM.get()), WoodType.SPRUCE),
						GenericWoodStorageRecipe::new)
		...
		ShapeBasedRecipeBuilder
				.shaped(items, WoodStorageBlockItem.setWoodType(new ItemStack(ModBlocks.LIMITED_BARREL_4_ITEM.get()), WoodType.SPRUCE),
						GenericWoodStorageRecipe::new)
	...
	private void addDoubleChestTierUpgradeRecipes(RecipeOutput recipeOutput, BlockItem baseTierItem, BlockItem copperTierItem, BlockItem ironTierItem,
		...
		ShapeBasedRecipeBuilder.shaped(items, copperTierItem, DoubleChestTierUpgradeRecipe::new).pattern("CCC").pattern("CSC").pattern("CBC")
				...
				.unlockedBy("has_" + RegistryHelper.getItemKey(baseTierItem).getPath(), has(baseTierItem)).save(recipeOutput,
						ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getRL("double_" + RegistryHelper.getItemKey(copperTierItem).getPath())));

		ShapeBasedRecipeBuilder.shaped(items, ironTierItem, DoubleChestTierUpgradeRecipe::new).pattern("III").pattern("ISI").pattern("III")
				.define('I', Tags.Items.INGOTS_IRON).define('S', copperTierItem)
				.unlockedBy("has_" + RegistryHelper.getItemKey(copperTierItem).getPath(), has(copperTierItem))
				.save(recipeOutput, ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getRL(
		...
		ShapeBasedRecipeBuilder.shaped(items, ironTierItem, DoubleChestTierUpgradeRecipe::new).pattern("III").pattern("ISI").pattern("IBI")
				...
				.unlockedBy("has_" + RegistryHelper.getItemKey(baseTierItem).getPath(), has(baseTierItem)).save(recipeOutput,
						ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getRL("double_" + RegistryHelper.getItemKey(ironTierItem).getPath())));
		...
		ShapeBasedRecipeBuilder.shaped(items, goldTierItem, DoubleChestTierUpgradeRecipe::new).pattern("GGG").pattern("GSG").pattern("GBG")
				...
				.unlockedBy("has_" + RegistryHelper.getItemKey(ironTierItem).getPath(), has(ironTierItem)).save(recipeOutput,
						ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getRL("double_" + RegistryHelper.getItemKey(goldTierItem).getPath())));
		...
		ShapeBasedRecipeBuilder.shaped(items, diamondTierItem, DoubleChestTierUpgradeRecipe::new).pattern("DDD").pattern("DSD").pattern("DBD")
				...
				.unlockedBy("has_" + RegistryHelper.getItemKey(goldTierItem).getPath(), has(goldTierItem)).save(recipeOutput,
						ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getRL("double_" + RegistryHelper.getItemKey(diamondTierItem).getPath())));
		...
		ShapelessBasedRecipeBuilder.shapeless(items, netheriteTierItem, DoubleChestTierUpgradeShapelessRecipe::new).requires(Ingredient.of(diamondTierItem))
				...
				.unlockedBy("has_" + RegistryHelper.getItemKey(diamondTierItem).getPath(), has(diamondTierItem)).save(recipeOutput,
						ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getRL("double_" + RegistryHelper.getItemKey(netheriteTierItem).getPath())));
	}
	...
	private void addControllerRelatedRecipes(RecipeOutput recipeOutput) {
		...
		WoodStorageBlockBase.CUSTOM_TEXTURE_WOOD_TYPES.forEach((woodType, blockSupplier) -> {
			...
			ShapeBasedRecipeBuilder.shaped(items, new ItemStack(ModBlocks.STORAGE_CONNECTOR_BLOCKS.get(woodType).get())).pattern("SPS").pattern("PSP")
	...
	private void addCompatUpgradeRecipe(RecipeOutput recipeOutput, Item upgrade, Block workbench, Item backpackUpgrade, String modId) {
		...
		ShapeBasedRecipeBuilder.shaped(items, upgrade).pattern("PUP").pattern(" P ").pattern("P P").define('P', ItemTags.PLANKS).define('U', backpackUpgrade)
				.unlockedBy("has_backpack_upgrade", has(backpackUpgrade)).save(sbCompatRecipeWithoutAdvancements,
						ResourceKey.create(Registries.RECIPE, ResourceLocation.fromNamespaceAndPath(SophisticatedStorage.MOD_ID,
								"storage_" + getCompatItemPath(upgrade) + "_from_backpack_" + getCompatItemPath(backpackUpgrade))));

		// backpack from storage upgrade
		ShapeBasedRecipeBuilder.shaped(items, backpackUpgrade).pattern("TUT").pattern(" L ").pattern("T T").define('T', Tags.Items.STRINGS)
				.define('L', Tags.Items.LEATHERS).define('U', upgrade).unlockedBy("has_storage_upgrade", has(upgrade)).save(sbCompatRecipeWithoutAdvancements,
						ResourceKey.create(Registries.RECIPE, ResourceLocation.fromNamespaceAndPath(SophisticatedStorage.MOD_ID,
	...
	private void addChestRecipes(RecipeOutput recipeOutput) {
		...
		ShapeBasedRecipeBuilder
				.shaped(items, WoodStorageBlockItem.setWoodType(new ItemStack(ModBlocks.CHEST_ITEM.get()), WoodType.OAK), GenericWoodStorageRecipe::new)
	...
	private void addQuarkChestRecipe(RecipeOutput recipeOutput, String name, WoodType woodType) {
		...
		ShapelessBasedRecipeBuilder.shapeless(items, WoodStorageBlockItem.setWoodType(new ItemStack(ModBlocks.CHEST_ITEM.get()), woodType)).requires(chestBlock)
				.requires(Blocks.LEVER)
				.save(recipeOutput.withConditions(new RegisteredCondition<>(ResourceKey.create(Registries.ITEM, ResourceLocation.parse(chestRegistryName)))),
	...
	private void addBarrelRecipes(RecipeOutput recipeOutput) {
		...
		ShapeBasedRecipeBuilder
				.shaped(items, WoodStorageBlockItem.setWoodType(new ItemStack(ModBlocks.BARREL_ITEM.get()), WoodType.SPRUCE), GenericWoodStorageRecipe::new)
	...
	private void woodBarrelRecipe(RecipeOutput recipeOutput, WoodType woodType, Block planks, Block slab) {
		ShapeBasedRecipeBuilder.shaped(items, WoodStorageBlockItem.setWoodType(new ItemStack(ModBlocks.BARREL_ITEM.get()), woodType)).pattern("PSP")
	...
	private void limitedWoodBarrelRecipe(RecipeOutput recipeOutput, WoodType woodType, Block planks, Block slab, Consumer<ShapedRecipeBuilder> addPattern,
			BlockItem item) {
		ShapedRecipeBuilder builder = ShapeBasedRecipeBuilder.shaped(items, WoodStorageBlockItem.setWoodType(new ItemStack(item), woodType)).define('P', planks)
		...
		builder.save(recipeOutput,
				ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getRL(woodType.name() + "_" + RegistryHelper.getItemKey(item).getPath())));
	}
	...
	private void woodChestRecipe(RecipeOutput recipeOutput, WoodType woodType, Block planks) {
		ShapeBasedRecipeBuilder.shaped(items, WoodStorageBlockItem.setWoodType(new ItemStack(ModBlocks.CHEST_ITEM.get()), woodType)).pattern("PPP")

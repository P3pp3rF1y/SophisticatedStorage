...
public class StorageRecipeProvider extends RecipeProvider {
	...
	private void addBackpackStackUpgradeFromStorageStackUpgradeRecipe(RecipeOutput recipeOutput, StackUpgradeItem backpackStackUpgrade, StackUpgradeItem storageStackUpgrade) {
		ShapeBasedRecipeBuilder.shaped(items, backpackStackUpgrade)
				...
				.save(recipeOutput, ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getIdentifier("backpack_" + RegistryHelper.getItemKey(backpackStackUpgrade).getPath() + "_from_storage_" + RegistryHelper.getItemKey(storageStackUpgrade).getPath())));
	}
	...
	private void addBackpackUpgradeFromStorageUpgradeRecipe(RecipeOutput recipeOutput, UpgradeItemBase<?> backpackUpgrade, UpgradeItemBase<?> storageUpgrade) {
		ShapeBasedRecipeBuilder.shaped(items, backpackUpgrade)
				...
				.save(recipeOutput, ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getIdentifier("backpack_" + RegistryHelper.getItemKey(backpackUpgrade).getPath() + "_from_storage_" + RegistryHelper.getItemKey(storageUpgrade).getPath())));
	}
	...
	private void addStorageUpgradeFromBackpackUpgradeRecipe(RecipeOutput recipeOutput, UpgradeItemBase<?> storageUpgrade, UpgradeItemBase<?> backpackUpgrade) {
		ShapeBasedRecipeBuilder.shaped(items, storageUpgrade)
				...
				.save(recipeOutput, ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getIdentifier("storage_" + RegistryHelper.getItemKey(storageUpgrade).getPath() + "_from_backpack_" + RegistryHelper.getItemKey(backpackUpgrade).getPath())));
	}
	...
	private void addStorageStackUpgradeFromBackpackStackUpgradeRecipe(RecipeOutput recipeOutput, StackUpgradeItem storageStackUpgrade, StackUpgradeItem backpackStackUpgrade) {
		ShapeBasedRecipeBuilder.shaped(items, storageStackUpgrade, 3)
				.pattern("PSP")
				.pattern(" P ")
				.pattern("P P")
				.define('P', ItemTags.PLANKS)
				...
				.save(recipeOutput, ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getIdentifier("storage_" + RegistryHelper.getItemKey(storageStackUpgrade).getPath() + "_from_backpack_" + RegistryHelper.getItemKey(backpackStackUpgrade).getPath())));
	}
	...
	private void addLimitedBarrelRecipes(RecipeOutput recipeOutput) {
		...
		ShapeBasedRecipeBuilder.shaped(items, ModBlocks.LIMITED_BARREL_1_ITEM.get(), woodStorageTemplate(ModBlocks.LIMITED_BARREL_1_ITEM.get(), WoodType.SPRUCE), GenericWoodStorageRecipe::new)
				.pattern("PSP")
				.pattern("PLP")
				.pattern("PPP")
				.define('P', ItemTags.PLANKS)
		...
		ShapeBasedRecipeBuilder.shaped(items, ModBlocks.LIMITED_BARREL_2_ITEM.get(), woodStorageTemplate(ModBlocks.LIMITED_BARREL_2_ITEM.get(), WoodType.SPRUCE), GenericWoodStorageRecipe::new)
				.pattern("PPP")
				.pattern("SLS")
				.pattern("PPP")
				.define('P', ItemTags.PLANKS)
		...
		ShapeBasedRecipeBuilder.shaped(items, ModBlocks.LIMITED_BARREL_3_ITEM.get(), woodStorageTemplate(ModBlocks.LIMITED_BARREL_3_ITEM.get(), WoodType.SPRUCE), GenericWoodStorageRecipe::new)
				.pattern("PSP")
				.pattern("PLP")
				.pattern("SPS")
				.define('P', ItemTags.PLANKS)
		...
		ShapeBasedRecipeBuilder.shaped(items, ModBlocks.LIMITED_BARREL_4_ITEM.get(), woodStorageTemplate(ModBlocks.LIMITED_BARREL_4_ITEM.get(), WoodType.SPRUCE), GenericWoodStorageRecipe::new)
				.pattern("SPS")
				.pattern("PLP")
				.pattern("SPS")
				.define('P', ItemTags.PLANKS)
	...
	private void addStorageTierUpgradeRecipes(RecipeOutput recipeOutput, BlockItem baseTierItem, BlockItem copperTierItem, BlockItem ironTierItem, BlockItem goldTierItem, BlockItem diamondTierItem, BlockItem netheriteTierItem) {
		...
		ShapeBasedRecipeBuilder.shaped(items, ironTierItem, StorageTierUpgradeRecipe::new)
				...
				.save(recipeOutput, ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getIdentifier(RegistryHelper.getItemKey(ironTierItem).getPath() + "_from_" + RegistryHelper.getItemKey(copperTierItem).getPath())));
	...
	private void addDoubleChestTierUpgradeRecipes(RecipeOutput recipeOutput, BlockItem baseTierItem, BlockItem copperTierItem, BlockItem ironTierItem, BlockItem goldTierItem, BlockItem diamondTierItem, BlockItem netheriteTierItem) {
		ShapeBasedRecipeBuilder.shaped(items, copperTierItem, DoubleChestTierUpgradeRecipe::new)
				...
				.define('S', baseTierItem)
				.unlockedBy("has_" + RegistryHelper.getItemKey(baseTierItem).getPath(), has(baseTierItem))
				.save(recipeOutput, ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getIdentifier("double_" + RegistryHelper.getItemKey(copperTierItem).getPath())));
		...
		ShapeBasedRecipeBuilder.shaped(items, ironTierItem, DoubleChestTierUpgradeRecipe::new)
				...
				.define('S', copperTierItem)
				.unlockedBy("has_" + RegistryHelper.getItemKey(copperTierItem).getPath(), has(copperTierItem))
				.save(recipeOutput, ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getIdentifier("double_" + RegistryHelper.getItemKey(ironTierItem).getPath() + "_from_" + RegistryHelper.getItemKey(copperTierItem).getPath())));
		...
		ShapeBasedRecipeBuilder.shaped(items, ironTierItem, DoubleChestTierUpgradeRecipe::new)
				...
				.unlockedBy("has_" + RegistryHelper.getItemKey(baseTierItem).getPath(), has(baseTierItem))
				.save(recipeOutput, ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getIdentifier("double_" + RegistryHelper.getItemKey(ironTierItem).getPath())));
		...
		ShapeBasedRecipeBuilder.shaped(items, goldTierItem, DoubleChestTierUpgradeRecipe::new)
				...
				.unlockedBy("has_" + RegistryHelper.getItemKey(ironTierItem).getPath(), has(ironTierItem))
				.save(recipeOutput, ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getIdentifier("double_" + RegistryHelper.getItemKey(goldTierItem).getPath())));
		...
		ShapeBasedRecipeBuilder.shaped(items, diamondTierItem, DoubleChestTierUpgradeRecipe::new)
				...
				.unlockedBy("has_" + RegistryHelper.getItemKey(goldTierItem).getPath(), has(goldTierItem))
				.save(recipeOutput, ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getIdentifier("double_" + RegistryHelper.getItemKey(diamondTierItem).getPath())));
		...
		ShapelessBasedRecipeBuilder.shapeless(items, netheriteTierItem, DoubleChestTierUpgradeShapelessRecipe::new)
				...
				.requires(Tags.Items.INGOTS_NETHERITE)
				.unlockedBy("has_" + RegistryHelper.getItemKey(diamondTierItem).getPath(), has(diamondTierItem))
				.save(recipeOutput, ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getIdentifier("double_" + RegistryHelper.getItemKey(netheriteTierItem).getPath())));
	}
	...
	private void addControllerRelatedRecipes(RecipeOutput recipeOutput) {
		...
		WoodStorageBlockBase.CUSTOM_TEXTURE_WOOD_TYPES.forEach((woodType, blockSupplier) -> {
			...
			ShapeBasedRecipeBuilder.shaped(items, ModBlocks.STORAGE_CONNECTOR_BLOCKS.get(woodType).get())
					.pattern("SPS")
					.pattern("PSP")
					.pattern("SPS")
	...
	private void addUpgradeRecipes(RecipeOutput recipeOutput) {
		...
		ShapeBasedRecipeBuilder.shaped(items, ModItems.AUTO_SMOKING_UPGRADE.get())
				...
				.save(recipeOutput, ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getIdentifier("auto_smoking_upgrade_from_auto_smelting_upgrade")));
		...
		ShapeBasedRecipeBuilder.shaped(items, ModItems.AUTO_BLASTING_UPGRADE.get())
				...
				.define('T', Items.SMOOTH_STONE)
				.unlockedBy("has_auto_smelting_upgrade", has(ModItems.AUTO_SMELTING_UPGRADE.get()))
				.save(recipeOutput, ResourceKey.create(Registries.RECIPE, SophisticatedStorage.getIdentifier("auto_blasting_upgrade_from_auto_smelting_upgrade")));
...
*/
	...
	private void addCompatUpgradeRecipe(RecipeOutput recipeOutput, Item upgrade, Block workbench, Item backpackUpgrade, String modId) {
		...
		ShapeBasedRecipeBuilder.shaped(items, upgrade)
				...
				.define('U', backpackUpgrade)
				.unlockedBy("has_backpack_upgrade", has(backpackUpgrade))
				.save(sbCompatRecipeWithoutAdvancements, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(SophisticatedStorage.MOD_ID, "storage_" + getCompatItemPath(upgrade) + "_from_backpack_" + getCompatItemPath(backpackUpgrade))));
		...
		ShapeBasedRecipeBuilder.shaped(items, backpackUpgrade)
				...
				.save(sbCompatRecipeWithoutAdvancements, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(SophisticatedStorage.MOD_ID, "backpack_" + getCompatItemPath(backpackUpgrade) + "_from_storage_" + getCompatItemPath(upgrade))));
	}
	...
	private void addChestRecipes(RecipeOutput recipeOutput) {
		...
		ShapeBasedRecipeBuilder.shaped(items, ModBlocks.CHEST_ITEM.get(), woodStorageTemplate(ModBlocks.CHEST_ITEM.get(), WoodType.OAK), GenericWoodStorageRecipe::new)
				.pattern("PPP")
				.pattern("PLP")
				.pattern("PPP")
				.define('P', ItemTags.PLANKS)
	...
	private void addQuarkChestRecipe(RecipeOutput recipeOutput, String name, WoodType woodType) {
		...
		ShapelessBasedRecipeBuilder.shapeless(items, ModBlocks.CHEST_ITEM.get(), woodStorageTemplate(ModBlocks.CHEST_ITEM.get(), woodType))
				.requires(chestBlock)
				.requires(Blocks.LEVER)
				.save(
	...
	private void addBarrelRecipes(RecipeOutput recipeOutput) {
		...
		ShapeBasedRecipeBuilder.shaped(items, ModBlocks.BARREL_ITEM.get(), woodStorageTemplate(ModBlocks.BARREL_ITEM.get(), WoodType.SPRUCE), GenericWoodStorageRecipe::new)
				.pattern("PSP")
				.pattern("PLP")
				.pattern("PSP")
				.define('P', ItemTags.PLANKS)
	...
	private void woodBarrelRecipe(RecipeOutput recipeOutput, WoodType woodType, Block planks, Block slab) {
		ShapeBasedRecipeBuilder.shaped(items, ModBlocks.BARREL_ITEM.get(), woodStorageTemplate(ModBlocks.BARREL_ITEM.get(), woodType))
				.pattern("PSP")
				.pattern("PLP")
				.pattern("PSP")
				.define('P', planks)
	...
	private void limitedWoodBarrelRecipe(RecipeOutput recipeOutput, WoodType woodType, Block planks, Block slab, Consumer<ShapeBasedRecipeBuilder> addPattern, BlockItem item) {
		ShapeBasedRecipeBuilder builder = ShapeBasedRecipeBuilder.shaped(items, item, woodStorageTemplate(item, woodType))
				.define('P', planks)
				.define('S', slab)
				.define('L', Blocks.LEVER)
				.unlockedBy("has_" + woodType.name() + PLANK_SUFFIX, has(planks));
	...
	private void woodChestRecipe(RecipeOutput recipeOutput, WoodType woodType, Block planks) {
		ShapeBasedRecipeBuilder.shaped(items, ModBlocks.CHEST_ITEM.get(), woodStorageTemplate(ModBlocks.CHEST_ITEM.get(), woodType))
				.pattern("PPP")
				.pattern("PLP")
				.pattern("PPP")
				.define('P', planks)
	...
	private static ItemStackTemplate tintedShulkerBoxTemplate(DyeColor color) {
		DataComponentPatch patch = DataComponentPatch.builder()
				.set(ModCoreDataComponents.MAIN_COLOR.get(), color.getTextureDiffuseColor())
				.set(ModCoreDataComponents.ACCENT_COLOR.get(), color.getTextureDiffuseColor())
				.build();
	...
	private void tintedShulkerBoxRecipe(RecipeOutput recipeOutput, Block vanillaShulkerBox, DyeColor dyeColor) {
		...
		ShapelessBasedRecipeBuilder.shapeless(items, ModBlocks.SHULKER_BOX_ITEM.get(), tintedShulkerBoxTemplate(dyeColor), ShulkerBoxFromVanillaShapelessRecipe::new)

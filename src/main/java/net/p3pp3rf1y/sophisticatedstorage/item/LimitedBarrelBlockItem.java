...
public class LimitedBarrelBlockItem extends BarrelBlockItem {
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> tooltipAdder, TooltipFlag tooltipFlag) {
		if (getBlock() instanceof LimitedBarrelBlock limitedBarrelBlock) {
			...
			tooltipAdder.accept(Component.translatable(StorageTranslationHelper.INSTANCE.translBlockTooltipKey(translationKey), String.valueOf(numberOfInventorySlots), String.valueOf(limitedBarrelBlock.getBaseStackSizeMultiplier())).withStyle(ChatFormatting.DARK_GRAY));
		}
	}
}

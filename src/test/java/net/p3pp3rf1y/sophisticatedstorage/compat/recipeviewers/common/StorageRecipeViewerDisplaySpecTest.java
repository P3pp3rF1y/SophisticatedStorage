...
class StorageRecipeViewerDisplaySpecTest {
	...
	void catalogOwnsExactTierUpgradeRecipeReplacement() {
		IRecipeViewerDisplayCatalog catalog = createCatalog();
		RecipeHolder<?> replacedRecipe = recipeHolderForId(catalog, ResourceLocation.fromNamespaceAndPath(SophisticatedStorage.MOD_ID, "iron_barrel"));
		RecipeHolder<?> unrelatedRecipe = recipeHolderForId(catalog, ResourceLocation.parse("test:unrelated"));
	...
	private static RecipeHolder<?> recipeHolderForId(IRecipeViewerDisplayCatalog catalog, ResourceLocation id) {
